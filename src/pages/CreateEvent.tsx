        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full px-5 py-4 rounded-2xl bg-stone-50 border border-stone-100 focus:border-emerald-500 focus:bg-white outline-none transition-all font-medium"
              value={name}
          ...
          <div>
            ...
            <div className="relative flex items-center">
              <span className="absolute left-5 text-stone-400 font-medium select-none">/</span>
              <input 
                type="text" 
                placeholder="mel-e-max" 
                className="w-full pl-8 pr-5 py-4 rounded-2xl bg-stone-50 border border-stone-100 focus:border-emerald-500 focus:bg-white outline-none transition-all font-medium"
                value={slug}
